			...
			<div class="middle-box-left">
				<div class="middle bg_middle">
					...
					<div class="cat_two_col">
						<div class="cat_l">
							<!-- slider -->
							<a id="cat_obj_pic_middle" class="cat_obj_pic_middle akcent new" href="img/cat/sum1.jpg">
								<img src="img/cat/sum1_middle.jpg" alt="Ципа - фото 1">
							</a>
							
							<ul class="cat_obj_fotos">
								<li>
									<a class="img" href="img/cat/sum1.jpg" data-sredimg="img/cat/sum1_middle.jpg">
										<img src="img/cat/sum1_min.jpg"  alt="Babe - foto 1">
									</a>
								</li>
								<li>
									<a class="img" href="img/cat/sum2.jpg" data-sredimg="img/cat/sum2_middle.jpg" >
										<img src="img/cat/sum2_min.jpg" alt="Babe - foto 2">
									</a>
								</li>
								<li>
									<a class="img" href="img/cat/sum3.jpg" data-sredimg="img/cat/sum3_middle.jpg">
										<img src="img/cat/sum3_min.jpg"  alt="Babe - foto 3">
									</a>
								</li>								
							</ul>
							<!-- //slider -->
              ...
              <p>Мягкость сумки: <strong>{{SOFTNESS}}</strong></p>
